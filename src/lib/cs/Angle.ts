export class Angle {
  static readonly RE_DMS = /^\s*(-?\d+)(?:\.(\d+)?|(?:[*° ](60|[0-5]?\d)(?:[ '](60|[0-5]?\d(?:\.\d{1,6})?)"?)?)?)\s*$/;
  static readonly RE_LAT = /^\s*(-?\d+)(?:\.(\d+)?|(?:[*° ](60|[0-5]?\d)(?:[ '](60|[0-5]?\d(?:\.\d{1,6})?)"?)?)?([NS])?)\s*$/;
  static readonly RE_LON = /^\s*(-?\d+)(?:\.(\d+)?|(?:[*° ](60|[0-5]?\d)(?:[ '](60|[0-5]?\d(?:\.\d{1,6})?)"?)?)?([WE])?)\s*$/;
